...
因此本页的定位不是复述机器学习知识点，而是把本 Wiki、原始资料目录和外部代码仓库连接起来，方便后续继续补课程简介、实验说明和复习路线。
...
- 目前不要把这页当作完整课程指南，它主要是外部仓库入口。
- 做实验时优先看外部仓库的 README、代码结构和实验说明，再回到本 Wiki 查资料边界。
- 实验报告和代码只适合学习参考，不要直接照搬提交。
- 后续补充课程经验前，应先读取外部仓库的真实 README、实验列表和运行方式。

## 待补充

- 需要补课程内容范围、实验列表、环境配置和运行入口。
- 需要把外部仓库的 README 摘要同步到 Wiki，但不复制代码和大型文件。
- 可以后续补“适合先学的机器学习基础”和“实验排错入口”。

## 资料边界

本页只做本仓库与外部代码仓库之间的导航。外部仓库代码和实验报告请按课程要求使用，不得直接照抄提交；后续内容应以真实仓库文件为准。
