...
| 类型 | 位置 | 说明 |
| --- | --- | --- |
| 课件 | `机器视觉技术/课件/` | 包含绪论、图像基础、二值图像、特征检测、CNN、图像分类、目标检测与图像分割，以及 `复习2026.pdf` |
| 往年题 | `机器视觉技术/往年真题及练习题/` | 当前收录两份机器视觉卷子，适合熟悉题型 |
| 考试回忆 | `机器视觉技术/2026 机器视觉回忆.md` | 按选择、判断、简答、解答、编程题整理的回忆版考点 |
| 实验资料 | `机器视觉技术/机器视觉实验 sfy/` | 实验二、三、四的报告、图片和 C++ 实现 |
| 实验与课程设计 | `机器视觉技术/机器视觉实验by fyr/` | 实验二、三、四的 MATLAB / C++ 实现，以及课程设计 Part1 / Part2 |
