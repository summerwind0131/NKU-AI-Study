...
| --- | --- | --- | --- | --- | ---: | --- |
| `中国近现代史纲要` | [进入页面](modern-chinese-history.md) | 精修 | 可用 | 空 README | 6 | pdf:2; md:2; docx:2 |
...
| `微分方程与复变函数` | [进入页面](differential-equations-complex-functions.md) | 精修 | 较完整 | 较完整 README | 38 | pdf:31; docx:4; md:3 |
| `思想道德与法治` | [进入页面](ideology-morality-law.md) | 精修 | 可用 | 可用 README | 5 | pdf:2; docx:2; md:1 |
...
| `高级语言程序设计2-2` | [进入页面](advanced-programming-2-2.md) | 精修 | 较完整 | 可用 README | 36 | docx:13; pdf:13; md:5; pptx:5 |
